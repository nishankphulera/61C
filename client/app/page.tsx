  ...
  return (
    ...
    >
      ...
      >
        ...
        <Asset scrollContainer={scrollRef} src="/Lego.png" className="w-[32rem] md:w-[34rem] opacity-50" parallax={0.2} scaleFactor={0.012} rotate={-15} position={{ top: "6%", left: "-15%" }} zIndex={5} />
