      ...
      >
        {isSceneInView && (
          <>
            ...
            <Asset progress={sceneProgress} src="/Vinyl.gif" className="w-[37.5rem] md:w-[45.5rem] opacity-100" parallax={0.36} scaleFactor={0.012} rotate={-3.7} position={{ top: pctOf(13.5, SCENE_HEIGHT_PX), left: pctOf(65.6, sceneWidthPx) }} zIndex={36} />
            ...
            <ParallaxLayer progress={sceneProgress} parallax={0.2} zIndex={50}>
              <Asset progress={sceneProgress} parallax={0} src="/Clapper v1.gif" className="w-[12rem] md:w-[17rem] opacity-68" scaleFactor={0.013} rotate={0} position={{ top: pctOf(2, SCENE_HEIGHT_PX), left: pctOf(12, sceneWidthPx) }} />
              ...
              <Asset progress={sceneProgress} parallax={0} src="/Converse.gif" className="w-[32rem] md:w-[42rem] opacity-68" scaleFactor={0.013} rotate={0} position={{ top: pctOf(10, SCENE_HEIGHT_PX), left: pctOf(-12, sceneWidthPx) }} />
            ...
            <Asset reverse={true} progress={sceneProgress} src="/Drone.gif" className="w-[21rem] md:w-[24rem] opacity-68" parallax={0.18} scaleFactor={0.012} rotate={-0.8} position={{ top: pctOf(0, SCENE_HEIGHT_PX), left: pctOf(-4, sceneWidthPx) }} zIndex={51} />
            <Asset progress={sceneProgress} src="/Lego.webp" className="w-[28rem] md:w-[34rem] opacity-90" parallax={0.2} scaleFactor={0.013} rotate={0} position={{ top: pctOf(18, SCENE_HEIGHT_PX), left: pctOf(1, sceneWidthPx) }} zIndex={51} />
            ...
            {/* WebP: transparent edges. MP4-only (no matching .webm) shows an opaque white matte on dark backgrounds. */}
            <Card title="FILMS" imageSrc="/Films.gif" width="44.2rem" onClick={() => router.push("/films")} rotate={-1} position={{ top: pctOf(6, SCENE_HEIGHT_PX), left: pctOf(0, sceneWidthPx) }} zIndex={100} />
            <Card title="PHOTOGRAPHY" imageSrc="/Photography.gif" width="56rem" onClick={() => router.push("/photography")} rotate={2} position={{ top: pctOf(-3, SCENE_HEIGHT_PX), right: pctOf(-2, sceneWidthPx) }} zIndex={52} />
            <Card title="Design" imageSrc="/Design.gif" width="56rem" onClick={() => router.push("/comingsoon")} rotate={2} position={{ top: pctOf(17, SCENE_HEIGHT_PX), right: pctOf(-2, sceneWidthPx) }} zIndex={52} />
          </>
        )}
      </div>
