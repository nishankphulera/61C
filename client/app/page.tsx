  ...
  return (
    ...
    >
      ...
      >
        ...
        <Asset scrollContainer={scrollRef} src="/Pelicancase.png" className="w-[16rem] md:w-[25rem] opacity-98" parallax={0.2} scaleFactor={0.01} rotate={-3} position={{ top: "10%", left: "17.9%" }} zIndex={31} />
        ...
        <Asset scrollContainer={scrollRef} src="/Vinyl.png" className="w-[35rem] md:w-[43rem] opacity-100" parallax={0.36} scaleFactor={0.012} rotate={6} position={{ top: "24.2%", left: "49.5%" }} zIndex={340} />
        ...
        <Asset scrollContainer={scrollRef} src="/Bread.png" className="w-[29.2rem] md:w-[35.2rem] opacity-100" parallax={0.26} scaleFactor={0.013} rotate={4} position={{ top: "28.5%", left: "-9%" }} zIndex={290} />
        <Asset scrollContainer={scrollRef} src="/Lighter.png" className="w-[9rem] md:w-[13rem] opacity-200" parallax={0.34} scaleFactor={0.013} rotate={14} position={{ top: "27.4%", left: "42%" }} zIndex={310} />
        <Asset scrollContainer={scrollRef} src="/Converse.png" className="w-[49rem] md:w-[52rem] opacity-100" parallax={0.3} scaleFactor={0.012} rotate={0} position={{ top: "45%", left: "-20%" }} zIndex={33} />
        <Asset scrollContainer={scrollRef} src="/lego.png" className="w-[32rem] md:w-[37rem] opacity-100" parallax={0.4} scaleFactor={0.013} rotate={2} position={{ top: "43%", left: "64%" }} zIndex={34} />
