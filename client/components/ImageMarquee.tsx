...
const ImageMarquee: React.FC<ImageMarqueeProps> = ({
  ...
  return (
    <section className="[--marquee-img:72px] md:[--marquee-img:140px] py-12 md:py-20 bg-[#050505] relative w-full overflow-hidden flex flex-col items-center justify-center border-y border-white/5">
      {/* Noise overlay */}
      <div
