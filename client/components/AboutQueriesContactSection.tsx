...
export default function AboutQueriesContactSection({
  showHeader = true,
  variant = "default",
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-none text-yellow-400">
        <div className="mx-auto mt-14 flex flex-row max-w-5xl items-stretch justify-center gap-0 text-[#ffef00] md:mt-20">
          <div className="flex-1 text-right pr-4 md:pr-10">
            ...
            <p className="mt-2 text-sm font-semibold md:text-3xl tracking-wide text-yellow-400">
              Registered address:
            </p>
            ...
            <p className="mt-2 text-sm font-semibold md:text-2xl tracking-wide text-[#FF009D] break-words">
              Phone:<br className="md:hidden" /> +44 7345651920
            </p>
          </div>

          <div className="shrink-0 self-stretch w-[2px] bg-[#518259]" aria-hidden />

          <div className="flex-1 text-left pl-4 md:pl-10">
            <p className="text-lg font-extrabold uppercase tracking-wide md:text-4xl text-yellow-400 mb-4 md:mb-[26px]">
              India Studio
            </p>
            <p className="mt-2 text-sm font-semibold md:text-3xl tracking-wide text-yellow-400">
            ...
            <p className="mt-2 text-sm font-semibold md:text-2xl tracking-wide text-[#FF009D] break-words">
              Phone:<br className="md:hidden" /> +91 8266029164
            </p>
          </div>
        </div>

        <div className="mx-auto mt-10 max-w-4xl items-center">
          ...
          <div className="mt-8 flex flex-row items-stretch justify-center gap-0">
            <div className="flex-1 pr-4 md:pr-10 text-right">
              <ul className="flex flex-col gap-3 text-sm sm:text-base md:text-2xl text-[#FF009D] font-semibold">
                <li>Manchester</li>
                <li>Liverpool</li>
                <li>Leeds</li>
                <li>Sheffield</li>
            ...
            <div className="flex-1 pl-4 md:pl-10 text-left">
              <ul className="flex flex-col gap-3 text-sm sm:text-base md:text-2xl text-[#FF009D] font-semibold">
                <li>Delhi - NCR</li>
                <li>Mumbai</li>
                <li>Bengaluru</li>
      ...
      <form
        onSubmit={onSubmit}
        className="mx-auto mt-10 max-w-4xl space-y-6 pb-16 md:mt-14"
      >
      ...
      <div className="text-yellow-400 mx-auto max-w-none pb-16">
